/** @type { {path:string, src?:string, keepUpdated?:true, description:string}[] } */
export const manifest = [
  ...
  },
  {
    ...
    description: "The layout reset component for the SvelteCMS Admin UI. In most cases, layout for the content paths should not affect the Admin UI."
  },
  {
